...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * Este método consiste en inicializar a los oyentes(listeners)
     */
    ...
    /**
     * Este método implementado es escuchar el clic en la vista(view)
     *
     * @param v
     */
    @Override
    ...
    /**
     * Este método consiste en validar los campos de texto de entrada y enviar datos a SQLite
     */
    private void postDataToSQLite() {
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim())) {
            ...
            // Snack Bar para mostrar el mensaje de éxito que el registro se guardó correctamente
            Snackbar.make(nestedScrollView, getString(R.string.success_message), Snackbar.LENGTH_LONG).show();
            emptyInputEditText();


        } else {
            // Snack Bar para mostrar el mensaje de error de que el registro ya existe
